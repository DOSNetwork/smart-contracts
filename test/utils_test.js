...
contract("Utils test", async() => {
    ...
    it("Test address to string", async() => {
        let stringValid = "0x0e7ad63d2a305a7b9f46541c386aafbd2af6b263";
        let addrValidResult = await utils.addr2Str.call(stringValid);
        //assert.equal(addrValidResult,stringValid, "transfer address to string");
    })

    // it("Test bytesConcat", async() => {

    // })

    it("Test strConcat", async() => {
        let aa = "Hello ";
        let bb = "world!";
    ...
    // it("Test bytesCompare", async() => {

    // })

    it("Test strCompare", async() => {
        let aa = "abd";
        let bb = "abcde";
    ...
    // it("Test bytesEqual", async() => {

    // })

    it("Test strEqual", async() => {
        let aa = "dosnetwork";
        let bb = "dosnetwork";
    ...
    // it("Test indexOf(bytes)", async() => {

    // })

    it("Test indexOf(string)", async() => {
        let haystack0 = "123";
        let needle0 = "";
        let haystack1 = "";
        let needle1 = "45";
    ...
    // it("Test subStr(bytes,uint,uint)", async() => {

    // })

    // it("Test subStr(bytes,uint)", async() => {

    // })

    // it("Test subStr(string,uint,uint)", async() => {
    ...
    it("Test subStr(string,uint)", async() => {
        let num = "123.4567";
